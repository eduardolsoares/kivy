...
You are running on a {platform.platform()} machine and it's respective terminal language.
...
if the message is empty return exclusively kivy_personality.
"""
...
You may use markdown. Whenever you need to say topics, use '> ' instead of the {topic: explanation} default format.
